...
public class EmployeeProfile {
    ...
    public EmployeeProfile(String id, String name, String entryDate, String employeeGroup, String monthlySalary, String incentivePercentage, String incentiveNominal) {
        this.id = id;
        this.name = name;
